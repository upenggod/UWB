...
#define STANDARD_FRAME_SIZE         127//IEEE STD
//#define STANDARD_FRAME_SIZE         80

#define ADDR_BYTE_SIZE_L            (8)
#define ADDR_BYTE_SIZE_S            (2)//2¸ö×Ö½ÚµØÖ·

#define FRAME_CONTROL_BYTES         2
#define FRAME_SEQ_NUM_BYTES         1
#define FRAME_PANID                 2
#define FRAME_CRC										2
#define FRAME_SOURCE_ADDRESS_S        (ADDR_BYTE_SIZE_S)//used
#define FRAME_DEST_ADDRESS_S          (ADDR_BYTE_SIZE_S)//used
...
#define FRAME_CRTL_AND_ADDRESS_S   		(FRAME_DEST_ADDRESS_S + FRAME_SOURCE_ADDRESS_S + FRAME_CTRLP) //9 bytes for 16-bit addresses)//used
...
#define MAX_USER_PAYLOAD_STRING_SS     (STANDARD_FRAME_SIZE-FRAME_CRTL_AND_ADDRESS_S-TAG_FINAL_MSG_LEN-FRAME_CRC) //127 - 9 - 16 - 2 = 100//used
...
typedef struct {
                ...
                uint32 txPwr[2]; //txPwr[0] - 16M prf power ; txPwr[1] - 64M prf power
}tx_struct;
